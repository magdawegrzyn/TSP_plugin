...
def runTSP(matrix,idList):
  ...
  if tsp_size > 0:
    ...
    dist_between_nodes.matrix = matrix
    ...
    if assignment:
      ...
      while not routing.IsEnd(index):
        ...
        currPlace = city_names[routing.IndexToNode(index)]
        optimalIdList.append(currPlace)
